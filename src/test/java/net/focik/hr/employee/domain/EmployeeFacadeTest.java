...
class EmployeeFacadeTest {
  ...
  //  @Autowired
    ...
    void should_add_Employee() {
        ...
        //when
        Integer resultId = employeeService.addEmployee(createEmployee());
    ...
    void should_throw_EmployeeNotValidException_when_name_is_null() {
        ...
        //then
        assertThrows(EmployeeNotValidException.class, () -> employeeService.addEmployee(employee));
    }
    @Test
    ...
    private Employee createEmployee(){
        ...
        Employee employee = new Employee(2,"Tomasz","Krutowski",0.5F, 26,
                ...
                WorkTime.FULL_TIME, EmployeeType.WORKER, null,0,null,null,null);
